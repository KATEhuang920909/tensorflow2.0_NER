...
if __name__ == '__main__':
    ...
    dp = DataProcess(data_type='renmin')
    train_data, train_label, test_data, test_label = dp.get_data(one_hot=False)
    print("shape", train_data.shape, train_label.shape, test_data.shape, test_label.shape)
    lstm_crf = BILSTMCRF(vocab_size=dp.vocab_size, n_class=dp.tag_size)
