...
if __name__ == '__main__':
    ...
    dp = DataProcess(max_len=100, data_type='renmin')
    train_data, train_label, test_data, test_label = dp.get_data(one_hot=False)

    model_class = IDCNNCRF(vocab_size=dp.vocab_size, n_class=dp.tag_size, max_len=100)
    ...
    # exit()
    for _ in range(10):
        model.fit(train_data, train_label, batch_size=64, epochs=1,
